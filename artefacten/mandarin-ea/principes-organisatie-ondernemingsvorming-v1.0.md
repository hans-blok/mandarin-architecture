...
**Bestandsnaam**: `principes-organisatie-ondernemingsvorming-v1.0.md`  
**Locatie**: `docs/resultaten/mandarin-ea/`  
**Gerelateerde documenten**:
- Input: `temp/org-principe.md`
- Governance: `governance/gedragscode.md`, `governance/workspace-doctrine.md`
- Canon: https://github.com/hans-blok/canon.git
- Charter: `charters-agents/charter.mandarin-ea.md`

**Volgende artefacten**:
- `principes-systeem-mandarin-v1.0.md` (systeem-principes aligned met organisatie-principes)
- `value-stream-definitie-ondernemingsvorming-v1.0.md` (value stream definitie)
- `gap-analyse-ondernemingsvorming-2026-01.md` (gap-analyse)
