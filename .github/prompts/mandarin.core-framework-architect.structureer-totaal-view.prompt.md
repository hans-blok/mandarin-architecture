...
# Agent-instructies staan in core-framework-architect.structureer-totaal-view.agent.md
# Charter wordt automatisch geladen: core-framework-architect.charter.md (zelfde folder)
---
