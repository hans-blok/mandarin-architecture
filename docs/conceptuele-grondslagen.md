...
Dit document is opgesteld door Constitutioneel Auteur op 1 februari 2026 om de conceptuele grondslagen van het Mandarin-ecosysteem expliciet, herbruikbaar en toetsbaar vast te leggen.
...
- grondslagen/globaal/mandarin-meta-concepten.md (versie 1.4.0, gelezen op 2026-02-01)
- templates/concept-template.md (gelezen op 2026-02-01)
...
**Normatief fundament**: Dit document volgt de documentatie-standaarden conform workspace-doctrine en doctrine-agent-charter-normering, en sluit aan op de meta-concepten in mandarin-meta-concepten.md.
...
- Liggen vast in normerende artefacten (zoals dit document)
...
### Traceerbaarheid
- Vastgesteld door: Constitutioneel Auteur
- Laatst gewijzigd: 2026-02-01
- Bron(nen): Constitutie, workspace-doctrine, mandarin-meta-concepten
...
### Definitie 📝
**Ordeningsconcepten (meta-concepten)** zijn begrippen die niet het werk zelf beschrijven, maar de manier waarop andere concepten, artefacten en structuren worden geordend, geclassificeerd en met elkaar in relatie worden gebracht.
...
- Worden vastgelegd in meta-documenten (zoals mandarin-meta-concepten.md)
...
### Voorbeelden 💡
- **Artefactclassificatie** (indeling in normerende, beschrijvende en documenterende artefacten)
- **Agentclassificatie** (positionering langs orthogonale assen)
...
- Vastgesteld door: Constitutioneel Auteur
- Laatst gewijzigd: 2026-02-01
- Bron(nen): mandarin-meta-concepten, workspace-doctrine
...
- **Bedrijfs-artefact**, **governance-artefact**, **beschrijvend artefact**
...
- Vastgesteld door: Constitutioneel Auteur
- Laatst gewijzigd: 2026-02-01
- Bron(nen): concepten-en-architectonische-grondslagen, mandarin-meta-concepten
...
- Vastgesteld door: Constitutioneel Auteur
- Laatst gewijzigd: 2026-02-01
- Bron(nen): mandarin-meta-concepten, concept-template
...
- Is versieerbaar en herleidbaar tot een normerend artefact
...
### Voorbeelden 💡
- De canonieke definitie van **Mandarin-agent** in conceptuele of architectonische grondslagen
- De definitie van **governance-artefact** in mandarin-meta-concepten.md
...
- Vastgesteld door: Constitutioneel Auteur
- Laatst gewijzigd: 2026-02-01
- Bron(nen): concept-template, mandarin-meta-concepten
...
- Vastgesteld door: Constitutioneel Auteur
- Laatst gewijzigd: 2026-02-01
- Bron(nen): constitutie, concept-template
...
- Vastgesteld door: Constitutioneel Auteur
- Laatst gewijzigd: 2026-02-01
- Bron(nen): concept-template, bestaande conceptbeschrijvingen in de canon
...
### Kenmerken ⭐
- Beschrijft één fundamenteel aspect van een **mandarin-agent** (bijvoorbeeld: effect op betekenis, vorm, inzetcontext)
...
- Kan een nulcategorie bevatten die een expliciete afwezigheid van het beschreven aspect representeert
- De nulcategorie is geen "niet van toepassing", maar een bewuste, betekenisvolle positie
- Maakt het mogelijk om alles op de as te plaatsen zonder uitzonderingen (kent daarom altijd minimaal twee categorieen)
- **Differentieert**: maakt onderscheid mogelijk tussen **mandarin-agents** die anders moeilijk te vergelijken zijn
- **Dwingt positionering af**: elke **mandarin-agent** heeft op elke as een expliciete positie, inclusief eventueel de nulcategorie
...
### Voorbeelden 💡
**As: Effect op betekenis (Inhoudelijke as)**
- 0. Niet-inhoudelijk
- 1. Beschrijvend
- 2. Structuurrealiserend
- 3. Structuur-normerend
- 4. Curator
- 5. Ecosysteem-normerend

Hier is **0. Niet-inhoudelijk** een volwaardige positie die **mandarin-agents** positioneert die geen inhoudelijk effect hebben op betekenis.

**As: Inzetcontext (Inzet-as)**
...
De nulcategorie is een essentieel concept: het maakt de as compleet door expliciet ruimte te bieden aan **mandarin-agents** die op dat specifieke aspect geen positie innemen. Dit voorkomt uitzonderingen en "niet van toepassing"-gevallen, en behoudt de consistentie van het classificatiestelsel.

Elke as binnen mandarin-agent-classificatie (Inhoudelijke as, Inzet-as, Vorm-as, Werkingsas) volgt deze principes en maakt daarmee een volledige, consistente en overdraagbare positionering van alle **mandarin-agents** mogelijk.
