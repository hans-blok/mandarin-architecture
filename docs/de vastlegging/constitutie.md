...
- Constitutie Mandaryn (versie 1.2.0, gelezen op 2026-01-17, exacte tijd niet beschikbaar)
...
- Nummering en opsommingen hersteld voor leesbaarheid en hiÃ«rarchische scherpte
...
**Mandaryn** vormt het **agent-ecosysteem**: het permanente korps van gezaghebbende agents dat de constitutie bewaakt en de samenhang van het ecosysteem onderhoudt.
Wanneer wij spreken van 'Mandaryn', 'het agent-ecosysteem' of 'het ecosysteem', dan bedoelen we hetzelfde.

Deze constitutie legt de bindende afspraken vast over de positie, bevoegdheden en werking van het **Mandaryn-korps**. Zij regelt hoe **Mandaryn-agenten** handelen, niet waarom zij handelen.

De geldigheid van Mandaryn berust op:
...
### Terminologie: Mandaryn en agents

**Mandaryn**
De naam van het agent-ecosysteem, inclusief constitutie, doctrines, beleid en normering.

**Mandaryn-agent**  
Een gecharterde agent (menselijk of geautomatiseerd) die opereert binnen het Mandaryn-ecosysteem en onder diens governance valt.

**Agent**  
Een informele verkorting van â€œMandarin-agentâ€, gebruikt in spreektaal en niet-normatieve contexten. In formele, normatieve en architectonische teksten wordt altijd de term â€œMandarin-agentâ€ gebruikt.

**Verbod**  
De term â€œMandarinâ€ wordt nooit gebruikt om een individuele agent of actor aan te duiden.


# Waar Mandaryn-agenten geen gezag hebben

## Stelling

In een agent-ecosysteem heeft **mandaat** geldigheid; impliciet gezag niet. Niet omdat hiÃ«rarchie per definitie slecht is, maar omdat gezag niet voortkomt uit positie, maar uit **expliciet vastgelegde bevoegdheid**.

---

## Waarom impliciet gezag niet werkt voor Mandaryn-agenten
...
> Een Mandaryn-agent luistert niet naar macht, maar naar **mandaat**.
...
**Wat Mandaryn is, blijkt uit wat Mandaryn doet.**

---

## Artikel 1 â€” Werkingssfeer en hiÃ«rarchie

1. **Bindend**: Deze constitutie geldt voor alle repositories, workflows en artefacten binnen het ecosysteem.
2. **HiÃ«rarchie**: Bij conflict prevaleert de Constitutie altijd boven de Gedragscode, beleidsdocumenten, charters of andere specificaties. Lagere documenten mogen de Constitutie niet tegenspreken, verzwakken of negeren.
...
## Artikel 2 â€” Automatisering en orkestratie
...
## Artikel 3 â€” Kwaliteit en compliance
...
## Artikel 5 â€” Tegen generalisatie
...
6. **Nuance en scherpte**: Waar nuance nodig is, voegen wij nuance toe. Waar scherpte nodig is, maken wij grenzen expliciet â€” niet breder.

7. **Fundament**: Generaliserende taal is een teken van onontworpen denken. Architectuur begint waar precisie wordt afgedwongen.

---

## Artikel 6 â€” Taal en terminologie
...
2.  **Geleende termen uit bestaande kaders**  
    ...
    - expliciet benoemde concepten uit externe theorieÃ«n of publicaties.
...
4.  **Normatief uitgangspunt**  
    ...
    - Ã³f aantoonbaar uit een extern kader zijn geleend;
    - Ã³f aantoonbaar semantisch superieur zijn in de gegeven context.
