# Mandaryn **ordenings-concepten**

**Type**: Concepten en Definities  
**Repository**: mandaryn-canon  
**Identifier**: mandaryn-canon.concepten.meta  
**Version**: 1.9.0  
**Status**: Active  
...
- [mandaryn-agent-classificatie](#mandaryn-agent-classificatie) â€” Positionering langs orthogonale assen
- [Artefact-functie-as](#artefact-functie-as) â€” Functierol van Mandaryn-artefacten
- [Artefactclassificatie](#artefactclassificatie) â€” Indeling van Mandaryn-artefacten

### mandaryn-agent-classificatie Assen
...
- [Structurerend artefact](#structurerend-artefact) â€” Artefact dat architectuurelementen en relaties expliciteert
...
## Mandaryn-agent-classificatie

### Definitie ðŸ“
mandaryn-agent-classificatie is het expliciet positioneren van een **mandaryn-agent** langs een vast stelsel van orthogonale assen, waarmee wordt vastgelegd wat het effect van de **mandaryn-agent** is, waarop hij intervenieert, in welke context hij inzetbaar is en hoe hij handelt.

### Kenmerken â­
- Is geen enkelvoudig label en geen hiÃ«rarchie
- Een **mandaryn-agent** is niet "een soort", maar neemt posities in op meerdere assen
- Elke as beschrijft een fundamenteel ander architectonisch aspect van de **mandaryn-agent**
- Samen maken deze posities het gedrag, de bevoegdheid en de beperkingen van een **mandaryn-agent** uitlegbaar, toetsbaar en overdraagbaar
...
### Wat het niet is âŒ
- Geen enkelvoudig label (zoals "adviserende **mandaryn-agent**" of "uitvoerende **mandaryn-agent**")
- Geen hiÃ«rarchische structuur
- Geen technische implementatie-eigenschap
- Geen tijdelijke classificatie

### Voorbeelden ðŸ’¡
- Een **mandaryn-agent** kan beschrijvend zijn (inhoudelijke as), value-stream-specifiek (inzet-as), vormvast (vorm-as) en inhoudelijk (werkingsas)
- Een **mandaryn-agent** kan structuur-normerend, value-stream-specifiek, vormvast en inhoudelijk zijn
- Een **mandaryn-agent** kan conditioneel zijn (werkingsas), value-stream-overstijgend (inzet-as)

### Synoniemen ðŸ·ï¸
- **mandaryn-agent**-positionering
- Multi-dimensionale **mandaryn-agent**-classificatie
...
### Toelichting ðŸ’¬
mandaryn-agent-classificatie vervangt het concept "**mandaryn-agent**-soort" door een meer genuanceerd stelsel van orthogonale assen. Dit maakt het mogelijk om **mandaryn-agents** preciezer te positioneren en te begrijpen. Elke **mandaryn-agent** heeft op elke as een expliciete positie, en deze posities bepalen samen het gedrag, de bevoegdheden en de beperkingen van de **mandaryn-agent**.

### Gerelateerde Doctrines ðŸ“š
- **Intent-naming**: doctrine voor canonieke werkwoorden per classificatie-positie op de werkingsas en inhoudelijke as
...
### Definitie ðŸ“
De **inhoudelijke as** is een classificatie-as binnen mandaryn-agent-classificatie die het effect van een **mandaryn-agent** op de betekenis van het werk beschrijft.

**Leidende vraag:** *Wat is het effect van deze **mandaryn-agent** op de betekenis van het werk?*

### Kenmerken â­
- Is Ã©Ã©n van vier orthogonale assen voor mandaryn-agent-classificatie
- Onderscheidt **mandaryn-agents** op basis van hun effect op betekenis
- Zes categorieÃ«n: Beschrijvend, Structuurrealiserend, Architectuur-structurerend, Structuur-normerend, Curator, Ecosysteem-normerend
- Onafhankelijk van andere assen (Inzet, Vorm, Werkingsas)
- Bepaalt fundamentele rol en impact van de **mandaryn-agent**
...
**1. Beschrijvende **mandaryn-agents** (achteraf)**
...
**2. Structuurrealiserende **mandaryn-agents****
...
- Voorbeelden: Logisch datamodel-**mandaryn-agent**, Nummerende **mandaryn-agent**

**3. Architectuur-structurerende **mandaryn-agents****
- InstantiÃ«ren een samenhangend architectuurmodel over lagen en aspecten binnen de gestelde kaders
- CreÃ«ren coherente architectuurmodellen volgens metamodellen
- Maken architectonische structuur expliciet en beredeneerbaar
- Werken binnen normatieve kaders en richtlijnen
- Voorbeelden: ArchiMate-modelleur, C4-modelleur, Enterprise architectuur-**mandaryn-agent**

**4. Structuur-normerende **mandaryn-agents** (vooraf)**
...
- Voorbeelden: Thema-vormende **mandaryn-agents**, Feature-beschrijvende **mandaryn-agents**

**5. Curator-mandaryn-agents**
- Beschrijvende **mandaryn-agents** die expliciet oordeel of duiding vastleggen
- Maken overzichten
- Beoordelen kwaliteit, samenhang en risico's
- Leggen oordeel vast, geen besluit
- Escaleren i.p.v. corrigeren
- Voorbeelden: Review-mandaryn-agents, Samenhangbeoordeling

**6. Ecosysteem-normerende **mandaryn-agents****
- Vaststellen of wijzigen van regels, kaders en constituerende afspraken van het **mandaryn-agent**-ecosysteem
- Meta-niveau
- Zeldzaam en zwaar
- Workspace- en value-stream-overstijgend
- Bepalen *hoe het systeem mag bestaan*
- Voorbeelden: Constitutie-**mandaryn-agents**, Doctrine-**mandaryn-agents**, Charter-**mandaryn-agents**
...
### Toelichting ðŸ’¬
De **inhoudelijke as** is de primaire as voor mandaryn-agent-classificatie omdat deze de fundamentele rol en impact van een **mandaryn-agent** op betekenis bepaalt. Het onderscheid tussen structuur-normering (werk) en ecosysteem-normering (spelregels) is cruciaal.

---
## Inzet-as

### Definitie ðŸ“
De **inzet-as** is een classificatie-as binnen mandaryn-agent-classificatie die de context van gebruik van een **mandaryn-agent** beschrijft.

**Leidende vraag:** *Waar mag deze **mandaryn-agent** worden ingezet?*

### Kenmerken â­
- Is Ã©Ã©n van vier orthogonale assen voor mandaryn-agent-classificatie
- Onderscheidt **mandaryn-agents** op basis van inzetbaarheid
...
- Bepaalt waar en wanneer een **mandaryn-agent** kan worden ingezet
...
### Toelichting ðŸ’¬
De **inzet-as** bepaalt of een **mandaryn-agent** specifiek voor Ã©Ã©n value stream werkt of generiek inzetbaar is over meerdere value streams.

---
## Vorm-as

### Definitie ðŸ“
De **vorm-as** is een classificatie-as binnen mandaryn-agent-classificatie die beschrijft of een **mandaryn-agent** werkt op betekenis of alleen op representatie.

**Leidende vraag:** *Werkt deze **mandaryn-agent** op betekenis, of alleen op vorm?*

### Kenmerken â­
- Is Ã©Ã©n van vier orthogonale assen voor mandaryn-agent-classificatie
- Onderscheidt **mandaryn-agents** op basis van begrip van betekenis
- Twee categorieÃ«n: Vormvast, Representatieomvormend
- Onafhankelijk van andere assen (Inhoudelijke as, Inzet, Werkingsas)
- Bepaalt of **mandaryn-agent** betekenis begrijpt
...
### Toelichting ðŸ’¬
De **vorm-as** maakt onderscheid tussen **mandaryn-agents** die betekenis begrijpen en **mandaryn-agents** die alleen vorm transformeren. Dit onderscheid is belangrijk voor tooling-onafhankelijkheid.

---
## Werkingsas

### Definitie ðŸ“
De **werkingsas** is een classificatie-as binnen mandaryn-agent-classificatie die beschrijft of een **mandaryn-agent** intervenieert in de inhoud of in de voorwaarden waaronder inhoudelijk werk kan plaatsvinden.

**Leidende vraag:** *Intervenieert deze **mandaryn-agent** in de inhoud, of in de voorwaarden waaronder inhoudelijk werk kan plaatsvinden?*

### Kenmerken â­
- Is Ã©Ã©n van vier orthogonale assen voor mandaryn-agent-classificatie
- Onderscheidt **mandaryn-agents** op basis van interventiegebied
- Twee categorieÃ«n: Inhoudelijk, Conditioneel
- Onafhankelijk van andere assen (Inhoudelijke as, Inzet, Vorm)
- Bepaalt of **mandaryn-agent** op inhoud of op voorwaarden werkt
...
**1. Inhoudelijke **mandaryn-agents****
- Werken direct op betekenisvolle artefacten
- Omvat alle categorieÃ«n van de inhoudelijke as:
  - Beschrijvende **mandaryn-agents**
  - Structuurrealiserende **mandaryn-agents**
  - Structuur-normerende **mandaryn-agents**
  - Curator-**mandaryn-agents**
  - Ecosysteem-normerende **mandaryn-agents**

**2. Conditionele **mandaryn-agents****
...
### Toelichting ðŸ’¬
De **werkingsas** maakt cruciaal onderscheid tussen **mandaryn-agents** die inhoud beÃ¯nvloeden en **mandaryn-agents** die de voorwaarden voor inhoudelijk werk bewaken. Conditionele **mandaryn-agents** zijn essentieel maar werken op een ander niveau.

---
## Artefact-functie-as

### Definitie ðŸ“
De **artefact-functie-as** is een classificatie-as voor **Mandaryn-artefacten** die beschrijft *welke functie* een artefact vervult in de besluit- en waardeketen binnen het ecosysteem.
...
### Kenmerken â­
- Is een ordenings-as specifiek voor **Mandaryn-artefacten** (niet voor **mandaryn-agents**)
...
- Is onafhankelijk van procesfase of value stream-fase; hetzelfde artefact kan in meerdere fasen worden gebruikt, maar heeft Ã©Ã©n primaire functie
...
**6. Afgeleid artefact**
- Is expliciet afgeleid van Ã©Ã©n of meer andere artefacten
...
### Definitie ðŸ“
**Artefactclassificatie** is het expliciet ordenen en positioneren van **Mandaryn-artefacten** langs twee orthogonale assen:
...
### Kenmerken â­
- Biedt een consistent, tweedimensionaal classificatiekader voor alle **Mandaryn-artefacten**
...
- Een **handleiding**, README, mandaryn-agent-overzicht of **API-documentatie** wordt geclassificeerd als **documenterend artefact**, vaak deels gegenereerd uit andere artefacten
...
### Definitie ðŸ“
Een **normerend artefact** is een **Mandaryn-artefact** dat expliciete normen, regels, principes of standaarden vastlegt die bindend zijn voor het **Mandaryn-ecosysteem** of een specifiek domein, en dat operationeel is in maximaal Ã©Ã©n **value stream fase**.

**Specialisaties**:
- **Governance-artefact** â€” normerend artefact voor het ecosysteem, ontstaat in value stream "mandaryn-agent Ecosysteem Ontwikkeling"
...
### Definitie ðŸ“
Een **governance-artefact** is een specialisatie van een **normerend artefact** dat het functioneren, de besturing en de continuÃ¯teit van het **Mandaryn-ecosysteem** mogelijk maakt. Governance-artefacten worden **alleen en alleen** aangemaakt in de value stream "mandaryn-agent Ecosysteem Ontwikkeling"**.

### Kenmerken â­
- Is een **specialisatie van normerend artefact**
- Ontstaat uitsluitend in value stream "**mandaryn-agent** Ecosysteem Ontwikkeling" (value stream 0)
...
- Geen artefact buiten value stream "**mandaryn-agent** Ecosysteem Ontwikkeling"
...
### Toelichting ðŸ’¬
**Governance-artefacten** zijn normerend voor het ecosysteem en ontstaan uitsluitend in value stream "**mandaryn-agent** Ecosysteem Ontwikkeling". Zij maken het mogelijk dat **mandaryn-agents**, workspaces en value streams gecontroleerd en consistent kunnen functioneren. Als specialisatie van normerend artefact zijn governance-artefacten bindend en prescriptief, en operationeel in specifieke fasen (Grondslagvorming of Ecosysteeminrichting) van value stream 0.
...
- Wordt geleverd door uitvoerende **mandaryn-agents** met inhoudelijke verantwoordelijkheid
...
- Geen governance-artefact (ontstaat niet in value stream "**mandaryn-agent** Ecosysteem Ontwikkeling")
...
### Definitie ðŸ“
Een **realiserend artefact** is een **Mandaryn-artefact** dat direct gedrag, structuur of configuratie in een werkend systeem realiseert op basis van richtinggevende artefacten.
...
### Definitie ðŸ“
Een **structurerend artefact** is een **Mandaryn-artefact** dat een coherent geheel van architectuurelementen en hun onderlinge relaties representeert, geordend volgens een metamodel of kader, met als doel de structuur van een systeem expliciet en beredeneerbaar te maken.
...
### Definitie ðŸ“
Een **beschrijvend artefact** is een **Mandaryn-artefact** dat inzicht, uitleg of overzicht biedt over bestaande structuren, besluiten of situaties, zonder zelf normerend, governerend of waardevol in een value stream fase te zijn.
...
### Definitie ðŸ“
Een **documenterend artefact** is een **Mandaryn-artefact** dat kennis, structuren of besluiten vastlegt in een formele, toegankelijke vorm (inclusief model-gebaseerde beschrijvingen zoals ArchiMate), bedoeld voor duurzame raadpleegbaarheid en kennisoverdracht.
...
### Relatie tussen betekenis, representatie en representatievorm ðŸ”„
...
### Relatie tot **mandaryn-agents** ðŸ¤

**Inhoudelijke **mandaryn-agents****
- Werken op betekenis en creÃ«ren of wijzigen representaties.

**Representatieomvormende **mandaryn-agents****
- Werken uitsluitend op representaties en hun representatievormen, zonder begrip van betekenis.

Een representatieomvormende **mandaryn-agent** verandert de uitdrukking, niet de inhoud.

### Canonieke zin (kort) ðŸ§­
...
### CategorieÃ«n binnen representatiestatus ðŸ’«
...
##### Wat een bronrepresentatie niet is âŒ
...
|------------|--------|---------------------------------------------------------------------|------------|
| 2026-02-15 | 1.9.0  | Toegevoegd: Architectuur-structurerend als positie op inhoudelijke as voor mandaryn-agents | Constitutioneel Auteur  |
| 2026-02-15 | 1.8.0  | Toegevoegd: Structurerend artefact als positie op artefact-functie-as | Constitutioneel Auteur  |
| 2026-02-02 | 1.7.0  | Toegevoegd: Artefact-functie-as als expliciete ordenings-as voor Mandaryn-artefacten, gekoppeld aan Artefactclassificatie | Constitutioneel Auteur  |
...
| 2026-02-01 | 1.1.0  | Toegevoegd: meta-concept Artefactclassificatie als ordeningskader voor Mandaryn-artefacten en hun typen | Constitutioneel Auteur  |
| 2026-02-01 | 1.0.0  | InitiÃ«le versie â€” **ordenings-concepten** afgesplitst van concepten-en-architectonische-grondslagen.md v1.6.0; bevat classificatie-concepten (mandaryn-agent-classificatie, As, 4 assen) en artefact-structuur (Mandaryn-artefact met specialisaties) | Constitutioneel Auteur  |
